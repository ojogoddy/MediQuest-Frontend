...
const AdminPatient = () => {
  ...
  return (
    <div className="">
        ...
        <div className="flex gap-5">
            <div className="mb-5">
                    <div className="bg-white shadow-md text-[#003189] p-4 rounded-lg space-y-5 w-[220px]">  
                ...
                <p className="text-[14px]">Total Patients</p>
                    ...
                    <div className="bg-white shadow-md text-[#003189] p-4 rounded-lg w-[220px] mt-5 space-y-5">  
                    <div className="space-y-4 flex justify-between items-center ">
            ...
            <div className="mb-5 ">
                    <div className="bg-white shadow-md text-[#003189] p-4 rounded-lg w-[220px] space-y-5">  
                    <div className="space-y-4 flex justify-between items-center ">
        ...
        <div className="bg-white shadow-md text-[#003189] p-4 rounded-lg mb-5 w-[100%]"></div>
        </div>

        <div className="flex gap-5">
        <div className='bg-white shadow-md text-[#003189] p-4 rounded-lg w-[100%] space-y-2'>
        ...
        <div 
        onClick={arrow}
        className="bg-[#003189] p-2 rounded-full w-8 text-white m-auto">
            <FaArrowDown/>
        </div>
    </div>
        <div className='bg-white shadow-md text-[#003189] p-4 rounded-lg w-[100%] space-y-2'>
